    ...
    return (
        <form action="" className="add-form" onSubmit={saveAd}>
            ...
            <p>
                <label>
                    Cena: <br/>
                    <input type="number" name="price" required maxLength={99} value={form.price}
                           onChange={e => updateForm('price', Number(e.target.value))}/>
                    <em>Pozowstaw zero w polu aby nie wyświetlać ceny</em>
                </label>
            </p>
            <p>
                <label>
            ...
            <p>
                <label>
                    ...
                    <input type="text" name="name" required maxLength={99} value={form.address}
